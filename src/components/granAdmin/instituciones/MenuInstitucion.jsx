        ...
        <nav className="-mx-3 bg-white border-b border-gray-200 dark:bg-gray-900 mb-6 relative">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <div className="flex items-center space-x-3 rtl:space-x-reverse mb-1">
                    <img src={logo ? RouteBackFile + logo : imagen.LOGO} className="h-8" alt="Institución Logo" />
                ...
                <div
                    className={`absolute top-full right-0 bg-white z-40 mt-2 w-full max-w-xs rounded-lg border border-gray-300 md:border-none md:static md:w-auto md:max-w-none md:mt-0 ${isOpen ? 'block' : 'hidden'} md:block`}
                    id="navbar-default"
                >
