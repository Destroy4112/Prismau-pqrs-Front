...
const Navbar = React.memo(({ toggleNav, toggleAside, open, usuario, credenciales, logout }) => {
    ...
    const rol = credenciales.rol.id == 1 ? "Gran Admin" : credenciales.rol.id == 2 ? 'Super Administrador' : credenciales.rol.id == 3 ? 'Administrador' : credenciales.rol.id == 4 ? "Consultor" : "Usuario";
