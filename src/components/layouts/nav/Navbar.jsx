...
const Navbar = React.memo(({ usuario, credenciales, logout }) => {
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center justify-start rtl:justify-end">
                        ...
                        <p className="flex ms-2 md:me-24">
                            <img src={imagen.LOGO} className="h-8 me-3" alt="FlowBite Logo" />
                    ...
                    <div className="flex items-center ms-3">
                        <div className="flex items-center ms-3">
                            ...
                            <div className="z-50 w-60 hidden absolute top-11 right-5 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown-user">
